...
//        Thread t2 = new Thread(desp2);
//        t2.start();
//        
//        Despertador desp3 = new Despertador();
//        desp3.setChamadaMetodo(VariaveisFinaisEstaticas.ESCOLHE_METODO_REMOVER);
//        Thread t3 = new Thread(desp3);
//        t3.start();
